...
<head>
  <meta charset="UTF-8">
  <title>Baza Ogłoszeń budowlanych</title>
  ...
  <style>
    ...
    .sidebar .menu li.logout { margin-top: 24px; color: #bbb; }
    .sidebar .menu li.logout a { color: #ff8787; text-decoration: none;}
    .container-content {
      flex: 1;
      padding: 18px 0 32px 240px;
      min-height: 100vh;
      background: #f5f6fa;
    }
    .header-bar {
      display: flex; align-items: center; gap: 18px;
      margin-bottom: 24px; margin-top: 8px; margin-left: 16px;
    }
    .header-logo {
      display: flex; flex-direction: column; align-items: center; margin-right: 0;
    }
    .header-logo img { height: 58px; width: auto; display: block; }
    .header-logo-text {
      font-size: 1.22em; font-weight: bold; margin-top: 2px; letter-spacing: -1px;
      color: #191919; font-family: Arial, Helvetica, sans-serif;
    }
    .header-title {
      font-size: 2em; font-weight: 600; color: #191919; letter-spacing: -1px;
      margin-left: 20px; font-family: Arial, Helvetica, sans-serif; margin-top: 5px;
    }
    .action-btns { margin-left: auto; display: flex; gap: 10px;}
    .action-btn {
      padding: 10px 26px; border: none; border-radius: 6px; font-size: 1em; font-weight: 600;
    ...
    .ad-desc-card {
      ...
      font-size: 1.18em;
      color: #222;
      /* DODANE: obsługa bardzo długiego tekstu */
